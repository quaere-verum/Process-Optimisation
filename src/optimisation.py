...
class SubtaskOptimisation(ScheduleStatus):
    ...
    def __post_init__(self):
        ...
        assert "TaskID" in self.all_items.columns, "Subtask optimisation assumes the dataframe consists of subtasks belonging to an overarching task, TaskID"
        assert "Order" in self.all_items.columns, "Subtask optimisation assumes the subtasks are ordered to account for dependencies"
